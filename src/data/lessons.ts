...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      {
        speaker: "직원 곰",
        text: "ただいま窓側をご確認いたします。二十三Aをご用意できます。いかがでしょうか。",
        pronunciation: "ただいままどがわをごかくにんいたします。にじゅうさんAをごようできます。いかがでしょうか。",
  ...
  },
  {
    ...
    dialogue: [
      ...
      {
        speaker: "매표원 곰",
        text: "G列の十二番と十三番はいかがでしょうか。スクリーンがよく見えるお席でございます。",
        pronunciation: "Gれつのじゅうにばんとじゅうさんばんはいかがでしょうか。スクリーンがよくみえるおせきでございます。",
  ...
  },
  {
    ...
    dialogue: [
      ...
      {
        speaker: "직원 곰",
        text: "午後三時から五時までのコートAがご利用いただけます。ラケットのレンタルもございます。",
        pronunciation: "ごごさんじからごじまでのコートAがごりようになれます。ラケットのレンタルもございます。",
  ...
  },
  {
    ...
    dialogue: [
      ...
      {
        speaker: "토끼",
        text: "JLPT対策の問題集を中心に、週に一度集まって互いに教え合えればと思っております。",
        pronunciation: "JPLTたいさくのもんだいしゅうをちゅうしんに、しゅうにいちどあつまってたがいにおしえあえればとおもっております。",
